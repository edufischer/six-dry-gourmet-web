        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
              Origem e <span className="text-yellow-500">Sustentabilidade</span>
            </h2>
            
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-yellow-600/20">
          ...
          <div className="relative">
            <div 
              className="h-96 rounded-lg bg-cover bg-center border border-yellow-600/20"
              style={{
