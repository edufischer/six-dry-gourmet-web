      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative mb-12">
            <div
              className="w-32 h-32 rounded-full flex items-center justify-center mx-auto shadow-2xl mb-8"
              style={{
            ...
            <div
              className="absolute inset-0 w-32 h-32 mx-auto rounded-full border-2 border-dashed opacity-20 animate-spin"
              style={{ borderColor: '#B56D57', animationDuration: '12s' }}
            ></div>
          </div>
