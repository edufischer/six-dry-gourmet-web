...
const Footer = () => {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-yellow-600/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-yellow-500 mb-4">Six Dry Aged</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <button
                ...
                className="w-10 h-10 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 shadow-lg shadow-yellow-600/20"
              >
                <Instagram className="w-5 h-5 text-zinc-950" />
              </button>
            </div>
            <a href="#" className="text-zinc-400 hover:text-yellow-500 transition-colors duration-300 text-sm">
